...
def print_rmc(lines):
    print("========================================RMC========================================")
    # print(lines, '\n')
    print("Fix taken at:", get_time(lines[1] + lines[9], "%H%M%S.%f%d%m%y", "%a %b %d %H:%M:%S %Y"), "UTC")
    print("Status (A=OK,V=KO):", lines[2])
    latlng = get_lat_lng(lines[3], lines[5])
...
def print_gga(lines):
    print("========================================GGA========================================")
    # print(lines, '\n')
    print("Fix taken at:", get_time(lines[1], "%H%M%S.%f", "%H:%M:%S"), "UTC")
    latlng = get_lat_lng(lines[2], lines[4])
...
def print_gll(lines):
    ...
    latlng = get_lat_lng(lines[1], lines[3])
    print("Lat,Long: ", latlng[0], lines[2], ", ", latlng[1], lines[4], sep='')
    print("Fix taken at:", get_time(lines[5], "%H%M%S.%f", "%H:%M:%S"), "UTC")
